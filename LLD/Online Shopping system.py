# Design and implement a simple Online Shopping System that allows users to:
# Register a user with name, email, and shipping addresses.
# Add products with price, inventory, and name.
# Add products to a shopping cart.
# Update quantity or remove items from the cart.
# Checkout the cart and create an order (without actual payment logic).
# Track order status through lifecycle: Created → Placed.
# Focus on User, Product, ShoppingCart, and Order with basic cart operations and order creation.
...
class Amazon:
    ...
    def checkout(self, user):
        ...
        print(f"Order placed successfully! Total: ${order.total_cost:.2f}")
        return order
